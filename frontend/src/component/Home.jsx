     ...
     return(
      ...
      {fitnessScore}
          ...
          <Typography variant="body2" color="white" fontFamily={'sans-serif'}>
            Based on your laHome tracking data, your score is 82 and considered Excellent. You're showing consistent gains — stay focused and keep pushing!
          </Typography>
          ...
          <Card className="card">
            <CardContent sx={{ backgroundColor: '#333333F0' }}>
              <Stack alignItems="center" spacing={1}>
                ...
                <Typography variant="body1" color="white" fontFamily={'sans-serif'} sx={{fontWeight:'bold'}}>Streak</Typography>
          ...
          <Card className="card">
            <CardContent sx={{ backgroundColor: '#333333F0' }}>
              <Stack alignItems="center" spacing={1}>
                ...
                <Typography variant="body1" color="white" fontFamily={'sans-serif'} sx={{fontWeight:'bold'}}>Workout</Typography>
          ...
          <Card className="card">
            <CardContent sx={{ backgroundColor: '#333333F0' }}>
              <Stack alignItems="center" spacing={1}>
                ...
                <Typography variant="body1" color="white" fontFamily={'sans-serif'} sx={{fontWeight:'bold'}}>Water</Typography>
          ...
          <Card className="card">
            <CardContent sx={{ backgroundColor: '#333333F0' }}>
              <Stack alignItems="center" spacing={1}>
                ...
                <Typography variant="body1" color="white" fontFamily={'sans-serif'} sx={{fontWeight:'bold'}}>Goal Completion</Typography>
